...
class yf_image_manip
{
     ...
     * @param mixed $dest_file_path
     * @param mixed $crop_width
     * @param mixed $crop_height
     * @param mixed $pos_left
     * @param mixed $pos_top
     */
     ...
     * @param mixed $source_file_path
     * @param mixed $dest_file_path
     * @param mixed $LIMIT_Width
     * @param mixed $LIMIT_Height
     * @param mixed $pos_left
     * @param mixed $pos_top
     */
    ...
    */
     ...
     * @param mixed $LIMIT
     */
    public function _imagick_rotate($source_file_path, $dest_file_path, $LIMIT)
    {
