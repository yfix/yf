...
class yf_user_ban
{
     ...
     * @param mixed $CUR_CHECKS
     * @param mixed $where_search
     */
     ...
     * @param mixed $phone
     */
    public function _complex_phone_search($input_text = '', $phone = '')
    {
     ...
     * @param mixed $where_search
     * @param mixed $what_to_search
     */
    public function _search_item($where_search = '', $what_to_search = '')
    {
        $IS_FOUND = false;
        if ($this->USE_REGEXES) {
