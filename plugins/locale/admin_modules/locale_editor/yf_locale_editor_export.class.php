...
//			->yes_no_box('is_template')
     ...
     * @param mixed $enc
     */
    public function _gen_csv(array $data = [], $delim = "\t", $enc = '"')
    {
    ...
    public function _gen_json(array $data = [])
    {
        if (count((array) $data) === 0) {
            return false;
        }
    ...
    public function _gen_yaml(array $data = [])
    {
        if (count((array) $data) === 0) {
            return false;
        }
    ...
    public function _gen_php(array $data = [])
    {
        if (count((array) $data) === 0) {
            return false;
        }
     ...
     * @param mixed $body
     * @param mixed $format
     * @param mixed $just_dump
     */
    public function _http_out($name, $body, $format, $just_dump = false)
    {
        no_graphics(true);
        $mime_map = [
            'csv' => 'text/csv',
