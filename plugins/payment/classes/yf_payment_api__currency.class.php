...
class yf_payment_api__currency
{
    ...
    public function update($options = null)
    {
        ...
        // store
        $result = db()->table('payment_currency_rate')->insert(
            $_currency_rate
            // , array( 'sql' => true, )
        );
        return  $result;
    ...
    public function provider($options = null)
    {
        ...
        if (@$_provider_id) {
            ...
            if ( ! is_array($index['provider']['id'][$_provider_id])) {
                return  $result;
            }
            $result = $index['provider']['id'][$_provider_id];
        }
        // allow
        if ( ! @$_is_force && ! @$this->provider_allow[$_provider]) {
            return  $result;
        }
