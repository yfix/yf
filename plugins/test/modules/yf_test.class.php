...
class yf_test
{
     ...
     * @param mixed $out
     */
    public function true_for_unittest($out = '')
    {
    ...
    public function change_debug()
    {
        if ( ! DEBUG_MODE) {
            return;
        }
        if (is_post()) {
            $_SESSION['debug_console_light'] = (int) ((bool) $_POST['debug_console_light']);
            $_SESSION['locale_vars_edit'] = (int) ((bool) $_POST['locale_edit']);
...
//			->active_box('stpl_edit', array('selected' => $_SESSION['stpls_inline_edit']))
     ...
     * @param mixed $params
     */
    public function html5fw($params = [])
    {
     ...
     * @param mixed $params
     */
    public function html5fw_empty($params = [])
    {
        return $this->_html5fw_test('empty', function ($fw, $params) {
        }, $params);
    }
     ...
     * @param mixed $params
     */
    public function html5fw_bs2($params = [])
    {
     ...
     * @param mixed $params
     */
    public function html5fw_bs3($params = [])
    {
     ...
     * @param mixed $params
     */
    public function html5fw_foundation($params = [])
    {
     ...
     * @param mixed $params
     */
    public function html5fw_pure($params = [])
    {
     ...
     * @param mixed $params
     */
    public function html5fw_semantic_ui($params = [])
    {
     ...
     * @param mixed $params
     */
    public function html5fw_uikit($params = [])
    {
     ...
     * @param mixed $params
     */
    public function html5fw_maxmert($params = [])
    {
     ...
     * @param mixed $params
     */
    public function _html5fw_test($fw = 'bs2', $callback, $params = [])
    {
        main()->no_graphics(true);
        _class('assets')->clean_all();
        if ( ! $params['use_yf_fixes'] && ! $_GET['use_yf_fixes']) {
...
';
    ...
    public function _transparent_png()
    {
        $w = $h = 200;
        $k = 4;
