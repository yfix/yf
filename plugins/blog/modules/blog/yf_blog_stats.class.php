	...
	*/
	function _show_stats() {
		...
		$replace = array(
			...
			"show_own_posts_link"	=> $this->BLOG_OBJ->USER_ID ? "./?object=".'blog'."&action=show_posts"._add_get(array("page")) : "",
			"change_settings_link"	=> $this->BLOG_OBJ->USER_ID ? "./?object=".'blog'."&action=settings"._add_get(array("page")) : "",
			...
			"rss_latest_button"		=> $this->BLOG_OBJ->_show_rss_link("./?object=".'blog'."&action=rss_for_all_blogs", "RSS feed for latest blogs posts"),
		);
