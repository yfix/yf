...
return function () { return ['versions' => ['master' => [
  'css' => '
  ...
  'jquery' => '
    $("body").popover({
      ...
      content: function() {
        ...
        if (uid) { return( yf_ajax_user_info(uid, _this) ); }
        return false;
      }
    })
    ...
    function yf_ajax_user_info(uid, _this) {
      ...
      if (typeof yf_cache_ajax_user_info[uid] === "string") { return yf_cache_ajax_user_info[uid]; }
