...
if ( ! function_exists('no_graphics')) {
    ...
    {
        return main()->no_graphics($val);
    }
}
if ( ! function_exists('is_no_graphics')) {
    function is_no_graphics()
    {
        return main()->no_graphics();
    }
}
...
if ( ! function_exists('is_cache_on')) {
    ...
    {
        return main()->is_cache_on();
    }
}
if ( ! function_exists('is_output_cache_on')) {
    function is_output_cache_on()
    {
        return main()->is_output_cache_on();
    }
}
if ( ! function_exists('is_mobile')) {
    function is_mobile()
    {
        return main()->is_mobile();
    }
}
