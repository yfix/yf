...
class yf_shop_contentm_panel {
	...
	*/
	...
	function _product_image_delete($id, $k) {
		$func = __FUNCTION__; return _class('manage_shop_product_images', 'admin_modules/shop_contentm_panel/')->$func($id, $k);
	}
	
	function _product_image_upload($product_id) {
		$func = __FUNCTION__; return _class('manage_shop_product_images', 'admin_modules/shop_contentm_panel/')->$func($product_id);
	}
		
	function product_image_delete() {
		$func = __FUNCTION__; return _class('manage_shop_product_images', 'admin_modules/shop_contentm_panel/')->$func();
	}	

	function _product_images_rename($id, $k, $mpath) {
		$func = __FUNCTION__; return _class('manage_shop_product_images', 'admin_modules/shop_contentm_panel/')->$func($id, $k, $mpath);
	}	
