...
class yf_shop_supplier_panel_categories {
	...
	*/
	function category_mapping() {
		...
		return table($sql, array(
			...
			->text('name')
			->btn_edit('','./?object='.$_GET['object'].'&action=category_mapping_edit&id=%d')
			->btn_delete('','./?object='.$_GET['object'].'&action=category_mapping_delete&id=%d')
			->footer_add('','./?object='.$_GET['object'].'&action=category_mapping_add');
	}
	...
	*/
	function category_mapping_add() {
		$SUPPLIER_ID = module('shop_supplier_panel')->SUPPLIER_ID;
		$a = array('back_link' => './?object='.$_GET['object'].'&action=category_mapping');
	...
	*/
	function category_mapping_edit() {
		...
		$a['back_link'] = './?object='.$_GET['object'].'&action=category_mapping';
	...
	*/
	function category_mapping_delete() {
		...
		return js_redirect('./?object='.$_GET['object'].'&action=category_mapping');
	}
}
