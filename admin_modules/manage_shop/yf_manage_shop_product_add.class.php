...
class yf_manage_shop_product_add {
	function product_add () {
		...
		return form2($r + (array)$_POST)
			...
			->db_insert_if_ok('shop_products', array('name'), array('active' => 0, 'supplier_id' => $supplier_id, 'add_date' => time()), array('on_after_update' => function($data, $table, $fields, $type, &$extra) {
				$id = db()->insert_id();
