...
*/
	...
	function yf_on_validation_change(is_valid, _this) {
		var control_group = _this.closest(".control-group");
		var controls = _this.closest(".controls");
console.log(controls, control_group)
		if (is_valid) {
			controls.removeClass(yf_css_class_error);
			control_group.removeClass(yf_css_class_error);
		} else {
	...
	$( "form" ).each(function() {
		...
		$( "input, select, textarea", form )
			...
			.on( "blur", function() {
				...
				yf_on_validation_change(this.validity.valid, this);
			})
