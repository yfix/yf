...
class class_db_real_mysql_test extends db_real_abstract
{
    ...
    public function test_utils()
    {
        ...
        $this->assertInternalType('object', self::db()->utils());
        $this->assertInternalType('object', self::db()->utils()->db);
    }
    public function test_query_builder()
    {
        ...
        $this->assertInternalType('object', self::db()->query_builder());
        $this->assertInternalType('object', self::db()->query_builder()->db);
    }
