...
class class_db_real_mysql_test extends db_real_abstract
{
    ...
    public function test_utils()
    {
        ...
        $this->assertIsObject(self::db()->utils());
        $this->assertIsObject(self::db()->utils()->db);
    }
    public function test_query_builder()
    {
        ...
        $this->assertIsObject(self::db()->query_builder());
        $this->assertIsObject(self::db()->query_builder()->db);
    }
