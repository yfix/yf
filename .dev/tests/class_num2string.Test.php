...
class class_num2string_test extends PHPUnit_Framework_TestCase {
	...
	public function test_num2str_eur_en() {
		...
		$this->assertEquals( 'two hundred twenty two milliard two hundred twenty two million two hundred twenty two thousands two hundred twenty two euros 22 cents', common()->num2str( 222222222222.222 ) );
	}
}
