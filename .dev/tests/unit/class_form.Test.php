...
class class_form_test extends yf\tests\wrapper {
	...
	public function test_input_text_value() {
		...
		$this->assertEquals('<input name="name" type="text" id="name" class="form-control" placeholder="Desc" value="value1">'
			, trim(self::form_no_chain($r)->text('name', ['desc' => 'Desc'])) );
		$this->assertEquals('<span class="stacked-item"><input name="name" type="text" id="name" class="form-control" placeholder="Desc" value="value1">'.PHP_EOL.'</span>'
			, trim(form($r, ['no_form' => 1])->text('name', ['stacked' => 1, 'desc' => 'Desc'])) );
		$this->assertEquals('<input name="name" type="text" id="name" class="form-control" style="color:red;" placeholder="Desc" value="value1">'
			, self::form_no_chain($r)->text('name', ['desc' => 'Desc', 'style' => 'color:red;']) );
		$this->assertEquals('<input name="name" type="text" id="name" class="form-control" style="color:red;" placeholder="Desc" value="value1">'
			, self::form_no_chain($r)->text('name', ['desc' => 'Desc', 'style' => 'color:red;', 'value' => 'value1']) );
	}
	...
	public function test_select_box_subarray() {
		...
		$this->assertEquals('<select name="myselect" id="select_box_1" class="form-control"><optgroup label="group1" title="group1"><option value="k1">v1</option><option value="k2">v2</option></optgroup>'.
			...
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->select_box('myselect', $data, ['force_id' => 'select_box_1']))) );
		$this->assertEquals('<select name="myselect" id="select_box_2" class="form-control"><optgroup label="group1" title="group1"><option value="k1">v1</option><option value="k2">v2</option></optgroup>'.
			...
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->select_box('myselect', $data, ['selected' => $selected, 'force_id' => 'select_box_2']))) );
		$r['myselect'] = $selected;
		$this->assertEquals('<select name="myselect" id="select_box_3" class="form-control"><optgroup label="group1" title="group1"><option value="k1">v1</option><option value="k2">v2</option></optgroup>'.
			'<optgroup label="group2" title="group2"><option value="k3" selected="selected">v3</option><option value="k4">v4</option></optgroup></select>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->select_box('myselect', $data, ['force_id' => 'select_box_3']))) );
	}
	public function test_multi_select_box() {
		...
		$this->assertEquals('<select name="myselect[]" id="multi_select_2" class="form-control" multiple="multiple"><option value="k1">v1</option><option value="k2" selected="selected">v2</option>'.
			...
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->multi_select_box('myselect', $data, ['selected' => $selected]))) );
		$r['myselect'] = $selected;
	...
	public function test_check_box() {
		...
		$this->assertEquals('<label class="'.$def_class.'"><input type="checkbox" name="id" id="id" value="1"> &nbsp;<span>Id</span></label>'
			, trim(self::form_no_chain($r)->check_box('id')) );
		$this->assertEquals('<label class="'.$def_class.' active"><input type="checkbox" name="id" id="id" value="1" checked="checked"> &nbsp;<span>Id</span></label>'
			, trim(self::form_no_chain($r)->check_box('id', ['selected' => 'true'])) );
		$this->assertEquals('<label class="'.$def_class.' active"><input type="checkbox" name="id" id="id" value="1" checked="checked"> &nbsp;<span>Id</span></label>'
			, trim(self::form_no_chain($r)->check_box('id', '1', ['selected' => 'true'])) );
		$this->assertEquals('<label class="'.$def_class.' active"><input type="checkbox" name="is_public" id="is_public" value="1" checked="checked"> &nbsp;<span>Is public</span></label>'
			, trim(self::form_no_chain($r)->check_box('is_public', '1', ['selected' => 'true'])) );
		$this->assertEquals('<label class="'.$def_class.' active"><input type="checkbox" name="is_public" id="is_public" value="1" checked="checked"> &nbsp;<span>Is public</span></label>'
			, trim(self::form_no_chain($r)->check_box('is_public', '1', ['checked' => 'true'])) );
		$this->assertEquals('<label class="'.$def_class.' active"><input type="checkbox" name="is_public" id="is_public" value="1" checked="checked"> &nbsp;<span>Is public</span></label>'
			, trim(self::form_no_chain($r)->check_box('is_public', ['checked' => 'true'])) );
		$this->assertEquals(
			...
			, trim(self::form_no_chain($r)->check_box('is_public', [
				'checked' => 'true',
...
#		)));
	...
	public function test_multi_check_box() {
		...
		$this->assertEquals('<label class="'.$def_class.'"><input type="checkbox" name="mycheck_k1" id="multi_check_box_1" value="k1"> &nbsp;<span>v1</span></label>'
		...
		$this->assertEquals('<label class="'.$def_class.'"><input type="checkbox" name="mycheck_k1" id="multi_check_box_3" value="k1"> &nbsp;<span>v1</span></label>'
	...
	public function test_radio_box() {
		$data = ['k1' => 'v1', 'k2' => 'v2'];
		$selected = 'k2';
		$this->assertEquals('<label class="radio radio-inline"><input type="radio" name="myradio" id="radio_box_1_1" value="k1"><span>v1</span></label>'
	...
	public function test_list_box() {
		$data = ['k1' => 'v1', 'k2' => 'v2'];
		$selected = 'k2';
		$this->assertEquals('<div id="mylist" class="bfh-selectbox" data-name="mylist"><div data-value="k1">v1</div><div data-value="k2">v2</div></div>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->list_box('mylist', $data))) );
		$this->assertEquals('<div id="mylist" class="bfh-selectbox" data-name="mylist" data-value="k2"><div data-value="k1">v1</div><div data-value="k2">v2</div></div>'
	...
	public function test_active_box() {
		...
		$this->assertEquals('<label class="radio radio-inline"><input type="radio" name="test" id="radio_box_1_1" value="0"><span><span class="btn btn-default btn-mini btn-xs btn-warning">'
	...
	public function test_allow_deny_box() {
		...
		$this->assertEquals('<label class="radio radio-inline"><input type="radio" name="test" id="radio_box_1_1" value="DENY"><span><span class="btn btn-default btn-mini btn-xs btn-warning">'
...
#			, trim(self::form_no_chain($r)->tbl_link_active('test')) );
	...
	public function test_stacked() {
		...
		$this->assertEquals('<span class="stacked-item"><input name="name" type="text" id="name" class="form-control" placeholder="'.$desc.'" value="'.$r['name'].'">'.PHP_EOL.'</span>'
			, trim(form($r, ['no_form' => 1])->text('name', ['desc' => $desc, 'stacked' => 1])) );
		...
		$this->assertEquals('<span class="my_stacked_class"><input name="name" type="text" id="name" class="form-control" placeholder="'.$desc.'" value="'.$r['name'].'">'.PHP_EOL.'</span>'
			, trim(form($r, ['no_form' => 1])->text('name', ['desc' => $desc, 'stacked' => ['class' => 'my_stacked_class']])) );
		...
		$this->assertEquals('<span class="stacked-item my_stacked_class"><input name="name" type="text" id="name" class="form-control" placeholder="'.$desc.'" value="'.$r['name'].'">'.PHP_EOL.'</span>'
			, trim(form($r, ['no_form' => 1])->text('name', ['desc' => $desc, 'stacked' => ['class_add' => 'my_stacked_class']])) );
		...
		$this->assertEquals('<span class="stacked-item my_stacked_class" style="float:none;"><input name="name" type="text" id="name" class="form-control" placeholder="'.$desc.'" value="'.$r['name'].'">'.PHP_EOL.'</span>'
			, trim(form($r, ['no_form' => 1])->text('name', ['desc' => $desc, 'stacked' => ['class_add' => 'my_stacked_class', 'style' => 'float:none;']])) );
		...
		$this->assertEquals('<span class="stacked-item my_stacked_class" style="float:none;"><button type="submit" name="name" id="name" class="btn btn-default btn-primary" value="Save">'.$desc.'</button>'.PHP_EOL.'</span>'
			, trim(form($r, ['no_form' => 1])->submit('name', ['desc' => $desc, 'stacked' => ['class_add' => 'my_stacked_class', 'style' => 'float:none;']])) );
	}
}
