...
class class_form_test extends PHPUnit_Framework_TestCase {
	...
	public function test_input_text() {
		...
		$this->assertEquals(str_replace(PHP_EOL, '', 
			...
			'</div>'.
			'</fieldset>'.
			'</form>'), str_replace(PHP_EOL, '', trim(form()->text('name'))) );
	}
	...
	public function test_select_box_subarray() {
		...
		$this->assertEquals('<select name="myselect" id="select_box_1" class="form-control"><optgroup label="group1" title="group1"><option value="k1">v1</option><option value="k2">v2</option></optgroup>'.
			'<optgroup label="group2" title="group2"><option value="k3">v3</option><option value="k4">v4</option></optgroup></select>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->select_box('myselect', $data, array('force_id' => 'select_box_1')))) );
		$this->assertEquals('<select name="myselect" id="select_box_2" class="form-control"><optgroup label="group1" title="group1"><option value="k1">v1</option><option value="k2">v2</option></optgroup>'.
			'<optgroup label="group2" title="group2"><option value="k3" selected="selected">v3</option><option value="k4">v4</option></optgroup></select>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->select_box('myselect', $data, array('selected' => $selected, 'force_id' => 'select_box_2')))) );
		$r['myselect'] = $selected;
		$this->assertEquals('<select name="myselect" id="select_box_3" class="form-control"><optgroup label="group1" title="group1"><option value="k1">v1</option><option value="k2">v2</option></optgroup>'.
			'<optgroup label="group2" title="group2"><option value="k3" selected="selected">v3</option><option value="k4">v4</option></optgroup></select>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->select_box('myselect', $data, array('force_id' => 'select_box_3')))) );
	}
	public function test_multi_select_box() {
		$data = array('k1' => 'v1', 'k2' => 'v2', 'k3' => 'v2');
		$selected = array('k2' => '1', 'k3' => '1');
		$this->assertEquals('<select name="myselect[]" id="multi_select_1" class="form-control" multiple="multiple"><option value="k1">v1</option><option value="k2">v2</option><option value="k3">v2</option></select>'
		...
		$this->assertEquals('<select name="myselect[]" id="multi_select_2" class="form-control" multiple="multiple"><option value="k1">v1</option><option value="k2" selected="selected">v2</option>'.
			'<option value="k3" selected="selected">v2</option></select>'
	...
	public function test_check_box() {
		...
		$this->assertEquals('<label class="checkbox checkbox-inline"><input type="checkbox" name="id" id="id" value="1" checked="checked"> &nbsp;Id</label>'
			, trim(self::form_no_chain($r)->check_box('id', array('selected' => 'true'))) );
		$this->assertEquals('<label class="checkbox checkbox-inline"><input type="checkbox" name="id" id="id" value="1" checked="checked"> &nbsp;Id</label>'
			, trim(self::form_no_chain($r)->check_box('id', '1', array('selected' => 'true'))) );
		$this->assertEquals('<label class="checkbox checkbox-inline"><input type="checkbox" name="is_public" id="is_public" value="1" checked="checked"> &nbsp;Is public</label>'
	...
	public function test_multi_check_box() {
		$data = array('k1' => 'v1', 'k2' => 'v2');
		$selected = array('k2' => '1');
		$this->assertEquals('<label class="checkbox checkbox-inline">	<input type="checkbox" name="mycheck_k1" value="k1" id="multi_check_box_1"  >	v1</label>'.
			'<label class="checkbox checkbox-inline">	<input type="checkbox" name="mycheck_k2" value="k2" id="multi_check_box_2"  >	v2</label>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->multi_check_box('mycheck', $data))) );
		$this->assertEquals('<label class="checkbox checkbox-inline">	<input type="checkbox" name="mycheck_k1" value="k1" id="multi_check_box_3"  >	v1</label>'.
			'<label class="checkbox checkbox-inline">	<input type="checkbox" name="mycheck_k2" value="k2" id="multi_check_box_4" checked >	v2</label>'
	...
	public function test_radio_box() {
		$data = array('k1' => 'v1', 'k2' => 'v2');
		$selected = 'k2';
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="myradio" value="k1" id="radio_box_1_1"  >	v1</label>'.
			'<label class="radio radio-inline">	<input type="radio" name="myradio" value="k2" id="radio_box_1_2"  >	v2</label>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->radio_box('myradio', $data, array('force_id' => 'radio_box_1')))) );
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="myradio" value="k1" id="radio_box_1_1"  >	v1</label>'.
			'<label class="radio radio-inline">	<input type="radio" name="myradio" value="k2" id="radio_box_1_2"  checked="checked">	v2</label>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->radio_box('myradio', $data, array('selected' => $selected, 'force_id' => 'radio_box_1')))) );
	}
	public function test_div_box() {
		$data = array('k1' => 'v1', 'k2' => 'v2');
		$selected = 'k2';
		$this->assertEquals('<li class="dropdown" style="list-style-type:none;" id="mydiv"><a class="dropdown-toggle" data-toggle="dropdown">Mydiv&nbsp;<span class="caret"></span></a>'.
		...
		$this->assertEquals('<li class="dropdown" style="list-style-type:none;" id="mydiv"><a class="dropdown-toggle" data-toggle="dropdown">v2&nbsp;<span class="caret"></span></a>'.
	...
	public function test_list_box() {
		$data = array('k1' => 'v1', 'k2' => 'v2');
		$selected = 'k2';
		$this->assertEquals('<div class="bfh-selectbox" id="mylist"><input type="hidden" name="mylist" value=""><a class="bfh-selectbox-toggle" role="button" data-toggle="bfh-selectbox" href="#">'.
			'<span class="bfh-selectbox-option bfh-selectbox-medium" data-option=""></span><b class="caret"></b></a><div class="bfh-selectbox-options"><input type="text" class="bfh-selectbox-filter">'.
			'<div role="listbox"><ul role="option"><li><a tabindex="-1" href="#" data-option="k1">v1</a></li><li><a tabindex="-1" href="#" data-option="k2">v2</a></li></ul></div></div></div>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->list_box('mylist', $data))) );
		$this->assertEquals('<div class="bfh-selectbox" id="mylist"><input type="hidden" name="mylist" value="k2"><a class="bfh-selectbox-toggle" role="button" data-toggle="bfh-selectbox" href="#">'.
			'<span class="bfh-selectbox-option bfh-selectbox-medium" data-option="k2">v2</span><b class="caret"></b></a><div class="bfh-selectbox-options"><input type="text" class="bfh-selectbox-filter">'.
			'<div role="listbox"><ul role="option"><li><a tabindex="-1" href="#" data-option="k1">v1</a></li><li><a tabindex="-1" href="#" data-option="k2">v2</a></li></ul></div></div></div>'
	...
	public function test_active_box() {
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="active" value="0" id="radio_box_1_1"  >	<span class="btn btn-default btn-mini btn-xs btn-warning">'.
			'<i class="icon-ban-circle fa fa-ban"></i> Disabled</span></label><label class="radio radio-inline">	<input type="radio" name="active" value="1" id="radio_box_1_2"  >	'.
			'<span class="btn btn-default btn-mini btn-xs btn-success"><i class="icon-ok fa fa-check"></i> Active</span></label>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->active_box('', array('force_id' => 'radio_box_1')))) );
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="test" value="0" id="radio_box_1_1"  >	<span class="btn btn-default btn-mini btn-xs btn-warning">'.
			'<i class="icon-ban-circle fa fa-ban"></i> Disabled</span></label><label class="radio radio-inline">	<input type="radio" name="test" value="1" id="radio_box_1_2"  >	'.
			'<span class="btn btn-default btn-mini btn-xs btn-success"><i class="icon-ok fa fa-check"></i> Active</span></label>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->active_box('test', array('force_id' => 'radio_box_1')))) );
	}
	public function test_allow_deny_box() {
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="active" value="DENY" id="radio_box_1_1"  >	<span class="btn btn-default btn-mini btn-xs btn-warning">'.
			'<i class="icon-ban-circle fa fa-ban"></i> Deny</span></label><label class="radio radio-inline">	<input type="radio" name="active" value="ALLOW" id="radio_box_1_2"  >	'.
			'<span class="btn btn-default btn-mini btn-xs btn-success"><i class="icon-ok fa fa-check"></i> Allow</span></label>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->allow_deny_box('', array('force_id' => 'radio_box_1')))) );
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="test" value="DENY" id="radio_box_1_1"  >	<span class="btn btn-default btn-mini btn-xs btn-warning">'.
			'<i class="icon-ban-circle fa fa-ban"></i> Deny</span></label><label class="radio radio-inline">	<input type="radio" name="test" value="ALLOW" id="radio_box_1_2"  >	'.
			'<span class="btn btn-default btn-mini btn-xs btn-success"><i class="icon-ok fa fa-check"></i> Allow</span></label>'
			, str_replace(PHP_EOL, '', trim(self::form_no_chain($r)->allow_deny_box('test', array('force_id' => 'radio_box_1')))) );
	}
	public function test_yes_no_box() {
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="active" value="0" id="radio_box_1_1"  >	<span class="btn btn-default btn-mini btn-xs btn-warning">'.
			'<i class="icon-ban-circle fa fa-ban-circle"></i> No</span></label><label class="radio radio-inline">	<input type="radio" name="active" value="1" id="radio_box_1_2"  >	'.
		...
		$this->assertEquals('<label class="radio radio-inline">	<input type="radio" name="test" value="0" id="radio_box_1_1"  >	<span class="btn btn-default btn-mini btn-xs btn-warning">'.
			'<i class="icon-ban-circle fa fa-ban-circle"></i> No</span></label><label class="radio radio-inline">	<input type="radio" name="test" value="1" id="radio_box_1_2"  >	'.
			'<span class="btn btn-default btn-mini btn-xs btn-success"><i class="icon-ok fa fa-check"></i> Yes</span></label>'
...
#		$r['back_link'] = 'http://somewhere.com/';
		$this->assertEquals('<button type="submit" name="back_link" id="back_link" class="btn btn-default btn-primary" value="Save"><i class="icon-save fa fa-save"></i> Save</button>'
			, trim(self::form_no_chain($r)->save_and_back()) );
		$this->assertEquals('<button type="submit" name="test" id="test" class="btn btn-default btn-primary" value="Save"><i class="icon-save fa fa-save"></i> Save</button>'
			, trim(self::form_no_chain($r)->save_and_back('test')) );
	}
	public function test_save_and_clear() {
		$this->assertEquals('<button type="submit" name="clear_link" id="clear_link" class="btn btn-default btn-primary" value="Save"><i class="icon-save fa fa-save"></i> Save</button>'
	...
	public function test_tbl_link_edit() {
		...
		$this->assertEquals('<a name="test" href="./?object=someobject&action=someaction" class="btn btn-default btn-mini btn-xs ajax_edit"><i class="icon-edit fa fa-edit"></i> test</a>'
	...
	public function test_tbl_link_delete() {
		...
		$this->assertEquals('<a name="test" href="./?object=someobject&action=someaction" class="btn btn-default btn-mini btn-xs ajax_delete btn-danger"><i class="icon-trash fa fa-trash"></i> test</a>'
	...
	public function test_tbl_link_view() {
		...
		$this->assertEquals('<a name="test" href="./?object=someobject&action=someaction" class="btn btn-default btn-mini btn-xs ajax_view"><i class="icon-eye-open fa fa-eye"></i> test</a>'
...
#			, trim(self::form_no_chain($r)->tbl_link_active('test')) );
		...
		$this->assertEquals('<a href="./?object=someobject&action=someaction" class="change_active"><button class="btn btn-default btn-mini btn-xs btn-warning">'.
			'<i class="icon-ban-circle fa fa-ban"></i> Disabled</button></a>'
			, trim(self::form_no_chain($r)->tbl_link_active('test')) );
	}
