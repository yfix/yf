...
class function_require_css_test extends PHPUnit_Framework_TestCase {
	public function test_detect_content_type() {
		...
		$this->assertEquals('url', _class('core_css')->_detect_content('http://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.3.2/contents.css'));
		$this->assertEquals('url', _class('core_css')->_detect_content('https://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.3.2/contents.css'));
		$this->assertEquals('url', _class('core_css')->_detect_content('//cdnjs.cloudflare.com/ajax/libs/ckeditor/4.3.2/contents.css'));
