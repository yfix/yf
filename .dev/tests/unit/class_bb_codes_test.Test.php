...
class class_bb_codes_test extends yf\tests\wrapper
{
    ...
    public function test_10()
    {
        ...
        $this->assertEquals(
            '<a href="http://www.google.com/intl/en_ALL/images/logo.gif" target="blank">http://www.google.com/intl/en_ALL/images/logo.gif</a>',
            self::_bbcode('[url]http://www.google.com/intl/en_ALL/images/logo.gif[/url]')
        );
        $this->assertEquals(
            '<a href="Google" target="blank">http://www.google.com/intl/en_ALL/images/logo.gif</a>',
        ...
        $this->assertEquals(
            '<div>quote <b></b> :</div><div class="forum_quote">Quote</div>',
            self::_bbcode('[quote]Quote[/quote]')
        );
        $this->assertEquals(
            '<div>quote <b>Vasya</b> :</div><div class="forum_quote">Quote Vasya</div>',
            self::_bbcode('[quote="Vasya"]Quote Vasya[/quote]')
        );
        $this->assertEquals(
            '<pre class="forum_code">some code here function, class</pre>',
            self::_bbcode('[code]some code here function, class[/code]')
        );
        $this->assertEquals(
            '<a href="http://google.com" target="blank"><img src="http://www.google.com/intl/en_ALL/images/logo.gif" border="0"></a>',
        ...
        $this->assertEquals(
            '<object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/xlOS_31Ubdo"></param><param name="wmode" value="transparent"></param><embed src="http://www.youtube.com/v/xlOS_31Ubdo" type="application/x-shockwave-flash" wmode="transparent" width="425" height="350"></embed></object>',
