...
class tpl_driver_yf_bugs_test extends tpl_abstract {
	...
	public function test_bug_06() {
		...
		$this->assertEquals('<script src="//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/js/bootstrap.js"></script>'
			, trim(self::_tpl($tpl_str, ['css_framework' => 'bs2', 'debug_mode' => 1])) );
		$this->assertEquals('<script src="//netdna.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.js"></script>'
			, trim(self::_tpl($tpl_str, ['css_framework' => 'bs3', 'debug_mode' => 1])) );
		$this->assertEquals('<script src="//netdna.bootstrapcdn.com/twitter-bootstrap/2.3.2/js/bootstrap.min.js"></script>'
			, trim(self::_tpl($tpl_str, ['css_framework' => 'bs2', 'debug_mode' => 0])) );
		$this->assertEquals('<script src="//netdna.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>'
			, trim(self::_tpl($tpl_str, ['css_framework' => 'bs3', 'debug_mode' => 0])) );
	}
