DROP TABLE IF EXISTS `sexy_user_data_main`;
CREATE TABLE IF NOT EXISTS `sexy_user_data_main` (
...
DROP TABLE IF EXISTS `sexy_user_data_info`;
CREATE TABLE IF NOT EXISTS `sexy_user_data_info` (
  `id` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `sexy_user_data_ban`;
CREATE TABLE IF NOT EXISTS `sexy_user_data_ban` (
  `id` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `sexy_user_data_stats`;
CREATE TABLE IF NOT EXISTS `sexy_user_data_stats` (
  `id` int(10) unsigned NOT NULL,
...
/*
CREATE VIEW `sexy_users` AS 
SELECT * FROM 
	`sexy_user_data_main`
	, `sexy_user_data_info`
	, `sexy_user_data_ban`
	, `sexy_user_data_stats`;
*/


INSERT IGNORE 
INTO `sexy_user_data_main`
SELECT 
  `id`,
  `group`,
  `name`,
...
SELECT * 
FROM 
	`sexy_user_data_main`   AS um
	,`sexy_user_data_info`  AS ui
	,`sexy_user_data_ban`   AS ub 
	,`sexy_user_data_stats` AS us
WHERE ui.id = um.id
	AND ub.id = um.id
	AND us.id = um.id
	AND um.id = 1;
