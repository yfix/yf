...
(function($) {
   ...
   ColorGenerator = function(colors) {
    ...
    $.jqplot.CanvasGridRenderer.prototype.init = function(options) {
        ...
        var sopts = {lineJoin:'round'/*'miter'*/, lineCap:'round', fill:false, isarc:false, angle:this.shadowAngle, offset:this.shadowOffset, alpha:this.shadowAlpha, depth:this.shadowDepth, lineWidth:this.shadowWidth, closePath:false};
