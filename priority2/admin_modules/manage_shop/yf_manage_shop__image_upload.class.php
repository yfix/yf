...
class yf_manage_shop__image_upload{
	...
	function _image_upload ($product_id, $product_name) {
		...
		foreach ((array)$_FILES['image'] ['tmp_name'] as $k => $v ) {
			...
			$img_path = module("manage_shop")->products_img_dir . $mpath.$product_name."_".$product_id."_".$i.module("manage_shop")->FULL_IMG_SUFFIX.".jpg";		
			$i = module("manage_shop")->_check_filed ($img_path, $product_id, $product_name, $i);
			$img_path = module("manage_shop")->products_img_dir . $mpath.$product_name."_".$product_id."_".$i.module("manage_shop")->FULL_IMG_SUFFIX.".jpg";
			$img_path_thumb = module("manage_shop")->products_img_dir . $mpath.$product_name."_".$product_id."_".$i.module("manage_shop")->THUMB_SUFFIX.".jpg";
