...
*
* @example
* $curlGoogle = new profy_curl_node('http://www.google.com/');
* $curlGoogle->setOpt(CURLOPT_HEADER, 0);
* $curlGoogle->addListener('callbackGoogle');
* 
* $curlMySpace = new profy_curl_node('http://www.myspace.com/');
* $curlMySpace->addListener('callbackMySpace');
*
* function callbackGoogle ($url, $html, $exec_time) {
* }
*
* curlNode::request();
*
**/
class profy_curl_node {
    ...
    static public function request(){
        ...
        foreach(self::$listenerList as &$listener){
            ...
            if (isset($listener['opt'])){
                foreach ((array)$listener['opt'] as $key => $value){
