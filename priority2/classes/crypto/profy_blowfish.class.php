...
/**
* Blowfish encrypt/decrypt algorithm class
* 
...
class profy_blowfish {
	...
	/** @var int @conf_skip The number of rounds to do */
	var $_rounds = 16;
	...
	*/
	function encrypt ($data) {
		for ($i = 0; $i < strlen($data); $i+=8) {
			...
			if (strlen($block) < 8) $block = $this->full_str_pad($block, 8, "\0", 1);
	...
	*/
	function decrypt ($data) {
		for ($i = 0; $i < strlen($data); $i+=8) 
			$decrypted .= $this->decryptBlock(substr($data, $i, 8));
		return $decrypted;
	}
