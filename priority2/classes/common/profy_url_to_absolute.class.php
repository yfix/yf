...
class profy_url_to_absolute {
	...
	function url_to_absolute( $baseUrl, $relativeUrl )
	{
		...
		if (substr_count($relativeUrl, "#") > 1) {
			$relativeUrl = substr($relativeUrl, 0, strpos($relativeUrl, "#", strpos($relativeUrl, "#") + 1));
		}
	 ...
	 */
	function join_url( $parts, $encode=null )
	{
		if (is_null($encode)) {
